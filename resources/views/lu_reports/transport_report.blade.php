      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item">
                  <a href="#!">Transporter Wise Report</a>
               </li>
            </ul>
         </div>
      </div>
                  ...
                  <div class="card table-card">
                     <div class="card-header flthd">
                        <div class="form-group row">
                           ...
                           <div class="col boxspace">
                              <select name="transporter" id="transporter" class="form-control boxbrd hgt">
                                 <option value="">Select Transporter</option>
                                 @foreach($transports as $transport)
                                 <option value="{{$transport['transport_code']}}">{{ ucfirst($transport['transport_name']) }}</option>
                                 @endforeach
                              </select>
                           </div>
                           ...
                           <div class="col-sm-1 boxspace">
                              <form action="{{route('loading.transport.report.download')}}" method="post">
                                 {{ csrf_field() }}
                                 ...
                                 <input type="hidden" name="transporter" id="transporter_id">
...
<script type="text/javascript">
   ...
   var tbl = $('#agent_datatable').DataTable({
           ...
           serverSide: true,
           ajax: {
               url: "{{ route('loading.transport.report') }}",
               type: 'GET',
               data: function (d) {
   ...
   $('#transporter').val($('#transporter_id').val());
