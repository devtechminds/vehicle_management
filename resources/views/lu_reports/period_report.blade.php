                     ...
                     <div class="card-header flthd">
                        <div class="form-group row">
                           <div class="col boxspace">
                              <a href="{{ route('loading.period.report')}}" title="Clear filter"><i class="fa fa-filter flt"></i></a>
                           </div>
                           <div class="col boxspace">
                           ...
                           <div class="col-sm-1 boxspace">
                              <form action="{{route('loading.period.report.download')}}" method="post">
                                 {{ csrf_field() }}
...
<script type="text/javascript">
   ...
   var tbl = $('#agent_datatable').DataTable({
           ...
           serverSide: true,
           ajax: {
               url: "{{ route('loading.period.report') }}",
               type: 'GET',
               data: function (d) {
