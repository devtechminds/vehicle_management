...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('weigh.bridge.entry.out.submit')}}" id="myform" method="post">
      @csrf
                     ...
                     <div class="card-block">
                        <div class="form-group row tblrw" style="border-bottom: 1px solid;
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                           <input type="text" name="initiated_by" class="form-control" value="{{ $gate_entry->initiated_by}}" readonly placeholder="Enter Initiated By" >
                              </div>
                              <label class="col-sm-2 col-form-label">Interchange No </label>
                              <div class="col-sm-4">
                                 <input type="text" name="interchange_no" class="form-control" value="{{ $gate_entry->interchange_no}}"  readonly placeholder="Enter Interchange No" >
                              </div>
                           </div>
                           <div class="form-group row">
   ...
   <div class="card-block">
      <form>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-4">
               <input type="text" name="cfs_release_no" class="form-control" value="{{ $gate_entry->getReleaseApprovalFinacialOfficerEntry->cfs_release_no}}" placeholder="" readonly="">
            </div>
            <label class="col-sm-2 col-form-label">Invoice No: </label>
            <div class="col-sm-4">
               <input type="text" name="invoice_no" class="form-control" value="{{ $gate_entry->getReleaseApprovalFinacialOfficerEntry->invoice_no}}" readonly placeholder="Enter Invoice No">
            </div>
         </div>
         <div class="form-group row">
            <label class="col-sm-2 col-form-label">CFS Release Date</label>
            <div class="col-sm-4">
               <input type="date" onkeydown="return false" name="cfa_release_date" class="form-control" readonly value="{{ $gate_entry->getReleaseApprovalFinacialOfficerEntry->cfa_release_date}}" placeholder="">
            </div>
            <label class="col-sm-2 col-form-label">Invoice Date: </label>
            <div class="col-sm-4">
               <input type="date" onkeydown="return false" name="invoice_date" class="form-control" value="{{ $gate_entry->getReleaseApprovalFinacialOfficerEntry->invoice_date}}" placeholder="" readonly>
            </div>
         </div>
         <div class="form-group row">
            <label class="col-sm-2 col-form-label">CFS Release Date</label>
            <div class="col-sm-4">
               <input type="date" onkeydown="return false" name="cfs_release_date" class="form-control" value="{{ $gate_entry->getReleaseApprovalFinacialOfficerEntry->cfs_release_date}}" placeholder="" readonly>
            </div>
            <label class="col-sm-2 col-form-label">CFS Release Exp Date</label>
            <div class="col-sm-4">
               <input type="date" onkeydown="return false" name="cfs_release_exp_date" class="form-control" value="{{ $gate_entry->getReleaseApprovalFinacialOfficerEntry->cfs_release_exp_date}}" placeholder="" readonly>
            </div>
         </div>
      </form>
   </div>
...
<div class="col-sm-4">
<input type="number" class="form-control" name="wb_gross_wt"  id="wb_gross_wt" value="" placeholder="Enter WB Gross Wt" readonly>
</div>
</div>
...
<input type="text" class="form-control" name="wb_net_wt"  id="wb_net_wt" value="" placeholder="" readonly="">
                                 ...
                                 <table class="table table-hover m-b-0" id="tbl">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td><input type="text" min="1" name="container_no" class="form-control cwth" value="{{$gate_entry->getConsignmentDetails->container_no}}" placeholder="Enter Container No" readonly></td>
	...
	<button name="action" value="process" class="btn btn-warning waves-effect waves-light" {{ $gate_entry->status == 2?'disabled':''}}>Proceed</button>
   <a class="btn btn-success waves-effect waves-light" target="_blank" href="{{route('weigh.bridge.entry.out.print',base64_encode($gate_entry->id))}}"> {{ $gate_entry->status == 1?'Print':'RePrint'}} <i class="fa fa-print"></i></a>
