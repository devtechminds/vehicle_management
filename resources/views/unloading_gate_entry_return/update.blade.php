      ...
      <div class="col-lg-4">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item">
                  <a href="#!">Vehicle after unloading</a>
               </li>
            </ul>
         </div>
      </div>
            ...
            <div class="card">
              <div class="card-block">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="destination" id="destination" value="{{ $unloadingGateEntry->destination}}" class="form-control" placeholder="" readonly>
                  </div>
            ...
            <div class="card">
                     <div class="card-block">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="wb_ticket_no" id="wb_ticket_no" value="{{ $unloadingGateEntry->getLuWeightBridge->wb_ticket_no}}" class="form-control" value="" placeholder="" readonly>
                              </div>
