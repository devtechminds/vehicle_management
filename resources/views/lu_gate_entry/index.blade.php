...
<li class="breadcrumb-item"><a href="{{route('loading.entry.create')}}" class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Manifesto</a></li>
</ul>
</div>
</div>
</div>
