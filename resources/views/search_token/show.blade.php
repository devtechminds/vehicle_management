...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('search.token.submit')}}" id="myform" method="post">
      @csrf
   ...
   <div class="card-block">
      <form>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-4">
               <input type="date" onkeydown="return false" name="cfs_extended_exp_date" class="form-control" value="" placeholder="" >
            </div>
         ...
         <div class="card">
            <div class="card-block height">
               ...
               <button class="btn btn-success waves-effect waves-light">Approve</button>
