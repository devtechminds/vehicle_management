                     ...
                     <div class="card-block">
                        @csrf
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="number" min="1" name="consignment_wgt" id="consignment_wgt" class="form-control" placeholder="Enter Consignment Weight">
                              </div>
                           </div>
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">No of Package  </label>
                              <div class="col-sm-4">
                                 <input type="number" min="1" name="no_package" id="no_package" class="form-control" placeholder="Enter No of Package">
                              </div>
                           </div>
                                       ...
                                       <table id="tableExample"  class="table tableExample table-hover m-b-0">
                                          ...
                                          <tbody>
                                             <tr class="line">
                                                ...
                                                <td><input type="text" name="container_no[0]"  class="form-control cwth  clone_input container_no" placeholder="Enter Container No"></td>
                                                <td><input type="number" min="1" name="size[0]"  class="form-control cwth   clone_input size" placeholder="Enter Size"></td>
                                                <td ><input type="text"  name="seal_s_no1[0]" class="form-control cwth required clone_input seal_s_no1" placeholder="Enter Seal No"></td>
                                                <td >
                                                   <select style="width: auto;" name="commodity[0]" class="form-control boxbrd required clone_input commodity_select">
                                                ...
                                                <td>
                                                <select   style="width: auto;" name="material[0]"  class="form-control boxbrd required clone_input material_select">
                                                ...
                                                <td>
                                                <select  style="width: auto;" name="uom[0]" id="uom" class="form-control boxbrd  clone_input">
                                                ...
                                                <td><input type="number" min="1"  name="declared_wgt[0]"  class="form-control cwth  clone_input" placeholder="Declared wgt"></td>
