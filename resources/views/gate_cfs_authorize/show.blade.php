      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item"><a href="#!">Gate entry officer
...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('gate.cfs.authorize.submit')}}" id="myform" method="post">
      @csrf
      ...
      <form>
         ...
         <div class="card">
            <div class="card-block height">
               ...
               <button class="btn btn-success waves-effect waves-light" {{$gate_entry->status=='1'?'disabled':''}}>Authorize</button>
