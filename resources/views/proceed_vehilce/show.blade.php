...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('proceed.form.gate.submit')}}" id="myform" method="post">
      @csrf
   ...
   @if($gate_entry->status=='1')
	...
	@else
   <a class="btn btn-success waves-effect waves-light" href="{{route('proceed.vehilce')}}">Back </a>
   @endif
   <a class="btn btn-success waves-effect waves-light" target="_blank" href="{{route('proceed.form.gate.print',base64_encode($gate_entry->id))}}">Print <i class="fa fa-print"></i></a>
