      ...
      <div class="col-lg-4">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item">
                  <a href="#!">Weigh Bridge Entry Updated After Return</a>
               </li>
            </ul>
         </div>
      </div>
...
<form action="{{route('loading.gate.entry.return.update.submit')}}" id="myform" method="post">
   <div class="main-body">
               ...
               <div class="card">
                     <div class="card-block">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-2">
                              <p class="bigf">Date:</p>
                              <input type="text" name="date" id="date" class="form-control bld"  value="{{ $loadingGateEntry->date}}" placeholder="">
                           </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-4">
                              <input type="text" name="time_in" id="time_in" class="form-control" placeholder="" value="{{ $loadingGateEntry->time_in}}">
                           </div>
                  ...
                  <div class="card">
                     <div class="card-block">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="wb_ticket_no" id="wb_ticket_no" value="{{ $loadingGateEntry->getLuWeightBridge->wb_ticket_no}}" class="form-control" value="" placeholder="">
                              </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="wb_tare_wt" id="wb_tare_wt" value="{{ $loadingGateEntry->getLuWeightBridge->wb_tare_wt}}" class="form-control calculate" value="" placeholder="">
                              </div>
                           </div>
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">WB Net Wt </label>
                              <div class="col-sm-4">
                                 <input type="text" name="wb_net_wt" id="wb_net_wt" class="form-control" value="{{ $loadingGateEntry->getLuWeightBridge->wb_net_wt}}" placeholder="" readonly>
                              </div>
                           </div>
                     </div>
                  </div>
