...
<li class="breadcrumb-item"><a href="#!">Shipment List</a></li>
<li class="breadcrumb-item"><a href="{{route('shipment.create')}}" class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Shipment</a></li>
</ul>
</div>
</div>
</div>
