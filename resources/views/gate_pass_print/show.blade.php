                                 ...
                                 <table class="table table-hover m-b-0" id="tbl">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td><input type="number"  name="container_no" class="form-control cwth" value="{{$gate_entry->getConsignmentDetails->container_no}}" placeholder="Enter Container No" readonly></td>
                                          ...
                                          <td><input type="text"  name="declared_wgt"  class="form-control cwth" value="{{$gate_entry->getConsignmentDetails->declared_wgt}}" placeholder="Enter Declared Wgt" readonly ></td>
