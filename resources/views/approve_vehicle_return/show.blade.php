      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item">
                  <a href="#!"> Operation Manager Approval
         ...
         <div class="card">
            <div class="card-block height">
               ...
               <button class="btn btn-success waves-effect waves-light">Approve</button>
	            @endif  
               @if($gate_entry->status=='3')
               <a href="{{route('operation.manager.entry')}}" class="btn btn-success waves-effect waves-light">Back</a>
	            @endif 
