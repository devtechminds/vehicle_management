...
<div class="d-inline">
<h4>Vehicle Return Selection Window(After Unloading)</h4>
...
<li class="breadcrumb-item"><a href="#!">Weighbridge Entry Updates After Return</a></li>
</ul>
</div>
</div>
</div>
...
<script type="text/javascript">
        $(document).ready( function () {
           var tbl = $('#agent_datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('list.unloading.gate.entry.return.update') }}",
                    type: 'GET',
                    data: function (d) {
                        d.status = $('#status').val();
                        d.ref_no = $('#ref_no').val();
