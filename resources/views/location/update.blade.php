...
<li class="breadcrumb-item"><a href="#!">Location Master Update</a></li>
</ul>
</div>
</div>
</div>
               ...
               <div class="col-sm-12">
                  <div class="card">
                     <div class="card-block">
                        <form action="{{route('location.update')}}" id="myform" method="post">
                        @csrf
                        {{method_field('put')}}
                        <input type="hidden" name="id" value="{{$uom->id}}">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="location" value="{{ ($uom->location?$uom->location:old('location')) }}" class="form-control" placeholder="Enter Location">
                              </div>
