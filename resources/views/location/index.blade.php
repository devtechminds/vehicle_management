      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item"><a href="#!">Location Master List</a></li>
               <li class="breadcrumb-item"><a href="{{route('location.create')}}" class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Location</a></li>
            </ul>
         </div>
      </div>
   </div>
...
<a href="{{ route('location.index')}}" title="Clear filter"><i class="fa fa-filter flt"></i></a>
</div>
