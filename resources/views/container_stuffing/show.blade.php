...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('container.stuffing.submit')}}" id="myform" method="post">
      @csrf
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="card">
                     ...
                     <input type="hidden" name="upload_documents_id" value="{{ $gate_entry->id }}">
...
<input type="text" name="field_supervisor_name" class="form-control " value="{{ auth()->user()->name}}" placeholder="" readonly="">
</div>
...
<div class="col-sm-10">
<textarea class="form-control" name="remarks" value="" placeholder="Enter Remarks" readonly>{{$gate_entry->remarks}}</textarea>
</div>
	...
	<button class="btn btn-warning waves-effect waves-light" {{ $gate_entry->out_process_status=='1'?'disabled':''}}>Save</button>
