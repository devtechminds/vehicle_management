...
<li class="breadcrumb-item"><a href="#!">Commodity Master Create</a></li>
</ul>
</div>
</div>
</div>
               ...
               <div class="col-sm-12">
                  <div class="card">
                     <div class="card-block">
                        <form action="{{route('commodities.store')}}" id="myform" method="post">
                        @csrf
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Commodity Name</label>
                              <div class="col-sm-4">
                                 <input type="text" name="commodity_name" value="{{old('commodity_name')}}" class="form-control" placeholder="Enter Commodity Name">
                              </div>
