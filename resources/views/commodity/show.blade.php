...
<li class="breadcrumb-item"><a href="#!">Commodity Master Show</a></li>
</ul>
</div>
</div>
</div>
                     ...
                     <div class="card-block">
                        ...
                        <input type="hidden" name="id" value="{{$agent->agent_code}}">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" readonly name="commodity_name" value="{{ ($agent->commodity_name?$agent->commodity_name:old('commodity_name')) }}" class="form-control" placeholder="Enter Agent Name">
                              </div>
                     ...
                     <div class="card-block height">
                        <div class="row">
                           <div class="col-sm-12" style="text-align: center;">
                              <a  href="{{route('commodities.index')}}" class="btn btn-success waves-effect waves-light">Back</a>
                           </div>
                        </div>
                     </div>
                  </div>
