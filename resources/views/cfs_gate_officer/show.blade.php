...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('authorize.vehicle.submit')}}" id="myform" method="post">
      @csrf
                     ...
                     <div class="card-block">
                        <div class="form-group row tblrw" style="border-bottom: 1px solid;
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="destination" class="form-control" value="{{ $gate_entry->destination}}" placeholder="Enter Destination" readonly>
                              </div>
                           </div>
                           <div class="form-group row">
            ...
            <div class="card-block height">
               <div class="form-group row dwn">
                  <div class="col-sm-12" style="text-align: center;">
                     ...
                     <a href="{{route('authorize.vehicle.in.index')}}"  class="btn btn-success waves-effect waves-light">Back</a>
                     @endif
