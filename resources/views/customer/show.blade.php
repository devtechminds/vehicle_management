...
<li class="breadcrumb-item"><a href="#!">Customer Master Show</a></li>
</ul>
</div>
</div>
</div>
                     ...
                     <div class="card-block">
                        ...
                        <input type="hidden" name="id" value="{{$agent->agent_code}}">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" readonly name="customer_name" value="{{ ($agent->customer_name?$agent->customer_name:old('customer_name')) }}" class="form-control" placeholder="Enter Agent Name">
                              </div>
                     ...
                     <div class="card-block height">
                        <div class="row">
                           <div class="col-sm-12" style="text-align: center;">
                              <a  href="{{route('customer.index')}}" class="btn btn-success waves-effect waves-light">Back</a>
                           </div>
                        </div>
                     </div>
                  </div>
