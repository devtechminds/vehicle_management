...
<form action="{{route('loading.gate.entry.proceed.process')}}" id="myform" method="post">
   <div class="main-body">
                  ...
                  <div class="card">
                     <div class="card-block">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="wb_tare_wt" id="wb_tare_wt" value="{{ $loadingGateEntry->getLuWeightBridge->wb_tare_wt}}" class="form-control" value="" placeholder="" readonly>
                              </div>
                           </div>
                           <div class="form-group row">
