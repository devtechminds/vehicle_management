      ...
      <div class="col-lg-4">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item">
                  <a href="#!">Authorization Unloading</a>
               </li>
            </ul>
         </div>
      </div>
...
<form action="{{route('unloading.gate.entry.approval.process')}}" id="myform" method="post">
  <div class="main-body">
              ...
              <div class="card-block">
                ...
                <div class="form-group row">
                  <div class="col-sm-2">
                    ...
                    <input type="hidden" name="id" id="id" class="form-control bld" value="{{$unloadingGateEntry->id}}" placeholder="" readonly="">
                  </div>
                  <div class="col-sm-8">
                  </div>
                  <div class="col-sm-2">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="time_in" id="time_in" value="{{ $unloadingGateEntry->time_in}}" class="form-control" placeholder="" value="{{  date('h:i A', strtotime(now())) }}" readonly>
                  </div>
            ...
            <div class="card">
              <div class="card-block height">
                <div class="row" >
                  ...
                  @if($unloadingGateEntry->status == 1)
                    <button class="btn btn-warning waves-effect waves-light">Update</button>
                    <a href="{{route('unloading.gate.entry.authorize',$unloadingGateEntry->id)}}" class="btn btn-success waves-effect waves-light">Authorize</a>
                  @else
                    <a href="{{route('unloading.gate.entry.approval.index')}}" class="btn btn-success waves-effect waves-light">Back</a>
                  @endif  
                  </div>
                </div>
              </div>
