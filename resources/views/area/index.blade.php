      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item"><a href="#!">Area Master List</a></li>
               <li class="breadcrumb-item"><a href="{{route('area.create')}}" class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Area</a></li>
            </ul>
         </div>
      </div>
   </div>
...
<a href="{{ route('area.index')}}" title="Clear filter"><i class="fa fa-filter flt"></i></a>
</div>
...
<div class="col boxspace">
<select name="select"  id="location"  class="form-control boxbrd hgt">
