...
<li class="breadcrumb-item"><a href="#!">Agent Master Create</a></li>
</ul>
</div>
</div>
</div>
               ...
               <div class="col-sm-12">
                  <div class="card">
                     <div class="card-block">
                        <form action="{{route('agent.store')}}" id="myform" method="post">
                        @csrf
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Agent Name</label>
                              <div class="col-sm-4">
                                 <input type="text" name="agent_name" value="{{old('agent_name')}}" class="form-control" placeholder="Enter Agent Name">
                              </div>
                              <label class="col-sm-2 col-form-label">Tin Number</label>
                              <div class="col-sm-4">
                                 <input type="number" min="1"  name="tin_no" value="{{old('tin_no')}}" class="form-control" placeholder="Enter Tin Number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxlength="15">
                              </div>
                           </div>
                           <div class="form-group row">
