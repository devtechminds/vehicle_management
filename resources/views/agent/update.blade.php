...
<li class="breadcrumb-item"><a href="#!">Agent Master Update</a></li>
</ul>
</div>
</div>
</div>
                     ...
                     <div class="card-block">
                        ...
                        <input type="hidden" name="id" value="{{$agent->agent_code}}">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text" name="agent_name" value="{{ ($agent->agent_name?$agent->agent_name:old('agent_name')) }}" class="form-control" placeholder="Enter Agent Name">
                              </div>
