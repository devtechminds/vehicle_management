        ...
        <div class="col-lg-6">
            <div class="page-header-breadcrumb">
                <ul class=" breadcrumb breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#!">Agents Master</a></li>
                    <li class="breadcrumb-item"><a href="#!">Agent Master List</a></li>
                    <li class="breadcrumb-item"><a href="{{route('agent.create')}}"
                            class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Agent</a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="card table-card">
                            ...
                            <div class="card-header flthd">
                                ...
                                <div class="form-group row">
                                    ...
                                    <a href="{{ route('agent.index')}}" title="Clear filter"><i class="fa fa-filter flt"></i></a>
                                    </div>
...
<option value="opt11">Empty Vechile comes in and Full container goes with vehicle</option>
                            ...
                            <div class="col-lg-12 boxspace">
                                <button class="btn viewModal btn-info" data-title="Active Agents " data-msg="Do you want to active all records"  data-name="" data-url="{{route('agent.status',['status'=>'active'])}}"  data-type="active" data-id="" data-type="active" data-id="" title="Active">Active</button>
                                <button class="btn viewModal btn-info" data-title="Inactive Agents " data-msg="Do you want to inactive all records"  data-name="" data-url="{{route('agent.status',['status'=>'inactive'])}}"  data-type="inactive" data-id="" data-type="inactive" data-id="" title="Inactive">Inactive</button>
                            </div>
