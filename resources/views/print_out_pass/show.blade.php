      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item"><a href="#!">CFS Gate Officer
...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('print.out.pass.submit')}}" id="myform1" method="post">
      @csrf
...
<input type="text" class="form-control" name="wb_net_wt"  id="wb_net_wt" value="{{ $gate_entry->wb_net_wt}}" placeholder="" readonly="">
         ...
         <div class="card">
            <div class="card-block height">
               ...
               <a target="_blank" href="{{ route('print.out.pass',base64_encode($gate_entry->id))}}"  class="btn btn-success waves-effect waves-light" title="Print">Print<i class="fa fa-print"></i></a>
</div>
               </div>
            </div>
         </div>
