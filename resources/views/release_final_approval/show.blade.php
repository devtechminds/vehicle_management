      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item"><a href="#!">Finance Controller


</a></li>
               <li class="breadcrumb-item">
                  <a href="#!">  Container Approval
...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('release.final.approval.submit')}}" id="myform" method="post">
      @csrf
      ...
      <form>
         ...
         <div class="card">
            <div class="card-block height">
               ...
               <button class="btn btn-success waves-effect waves-light" {{$gate_entry->status==1?'disabled':''}}>Approve</button>
                @if($gate_entry->status==1)
               <a target="_blank" href="{{ route('release.final.approval.print',base64_encode($gate_entry->id))}}"  class="btn btn-success waves-effect waves-light" title="Print">Print<i class="fa fa-print"></i></a>
	             @endif
</div>
               </div>
            </div>
