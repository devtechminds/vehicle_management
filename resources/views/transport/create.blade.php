...
<li class="breadcrumb-item"><a href="#!">Transport Master Create</a></li>
</ul>
</div>
</div>
</div>
               ...
               <div class="col-sm-12">
                  <div class="card">
                     <div class="card-block">
                        <form action="{{route('transport.store')}}" id="myform" method="post">
                        @csrf
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Transport Name</label>
                              <div class="col-sm-4">
                                 <input type="text" name="transport_name" value="{{old('transport_name')}}" class="form-control" placeholder="Enter Transport Name">
                              </div>
