...
<li class="breadcrumb-item"><a href="#!">Transport Master Update</a></li>
</ul>
</div>
</div>
</div>
               ...
               <div class="col-sm-12">
                  <div class="card">
                     <div class="card-block">
                        <form action="{{route('transport.update')}}" id="myform" method="post">
                        @csrf
                        {{method_field('put')}}
                        <input type="hidden" name="id" value="{{$agent->transport_code}}">
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Transport Name</label>
                              <div class="col-sm-4">
                                 <input type="text" name="transport_name" value="{{ ($agent->transport_name?$agent->transport_name:old('transport_name')) }}" class="form-control" placeholder="Enter Transport Name">
                              </div>
                              <label class="col-sm-2 col-form-label">Tin Number</label>
                              <div class="col-sm-4">
                                 <input type="number" name="tin_no" value="{{ ($agent->tin_no?$agent->tin_no:old('tin_no')) }}" class="form-control" placeholder="Enter Tin Number">
                              </div>
                           </div>
                           <div class="form-group row">
