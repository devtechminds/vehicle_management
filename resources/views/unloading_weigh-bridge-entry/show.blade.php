   ...
   <div class="row align-items-end">
      <div class="col-lg-8">
         <div class="page-header-title">
            ...
            <div class="d-inline">
               <h3>VEHICLE SLIP FORM(UNLOADING)</h3>
            </div>
         </div>
      </div>
      <div class="col-lg-4">
...
<form action="{{route('unloading.weigh.bridge.officer.submit')}}" id="myform" method="post">
   <div class="main-body">
                        ...
                        <form>
                           <div class="form-group row">
                              <div class="col-sm-2">
                                 ...
                                 <input type="hidden" name="loading_gate_entry_id" value="{{ $unloadingGateEntry->id}}">
