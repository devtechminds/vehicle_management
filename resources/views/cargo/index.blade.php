...
<li class="breadcrumb-item"><a href="#!">Cargo Master List</a></li>
<!-- <li class="breadcrumb-item"><a href="{{route('cargo.create')}}" class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Cargo</a></li> -->
</ul>
</div>
</div>
</div>
...
<a href="{{ route('cargo.index')}}" title="Clear filter"><i class="fa fa-filter flt"></i></a></div>
...
<div class="col-lg-12 boxspace">
    <button class="btn viewModal btn-info" data-title="Active Cargo" data-msg="Do you want to active all records"  data-name="" data-url="{{route('cargo.status',['status'=>'active'])}}"  data-type="active" data-id="" data-type="active" data-id="" title="Active">Active</button>
    <button class="btn viewModal btn-info" data-title="Inactive Cargo" data-msg="Do you want to inactive all records"  data-name="" data-url="{{route('cargo.status',['status'=>'inactive'])}}"  data-type="inactive" data-id="" data-type="inactive" data-id="" title="Inactive">Inactive</button>
</div>
        ...
        $(document).ready( function () {
           var tbl = $('#agent_datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'cargo_name', name: 'cargo_name'},
