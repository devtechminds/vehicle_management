      ...
      <div class="col-lg-6">
         <div class="page-header-breadcrumb">
            <ul class=" breadcrumb breadcrumb-title">
               ...
               <li class="breadcrumb-item"><a href="#!">Yard Master List</a></li>
               <li class="breadcrumb-item"><a href="{{route('bin.create')}}" class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Yard</a></li>
            </ul>
         </div>
      </div>
   </div>
...
<a href="{{ route('bin.index')}}" title="Clear filter"><i class="fa fa-filter flt"></i></a>
</div>
   ...
   $(document).ready( function () {
     var tbl = $('#uom_datatable').DataTable({
           ...
           columns: [
               ...
               {data: 'area_id', name: 'area_id',render:function(data, type, row){
                        if(row.get_area){
                            return row.get_area.area;
                        }
                        else{
                            return '';
                        }
                    }},
               {data: 'location_id', name: 'location_id',render:function(data, type, row){
                        if(row.get_location){
                            return row.get_location.location;
                        }
                        else{
                            return '';
                        }
