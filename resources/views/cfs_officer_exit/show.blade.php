...
<div class="col-sm-4">
<input type="number" min="1" name="container_tare_wt" class="form-control" value="" placeholder="Enter Container Tare Wt" >
</div>
<label class="col-sm-2 col-form-label">WB Tare Wt</label>
<div class="col-sm-4">
<input type="number" min="1" class="form-control" name="wb_tare_wt" value="" placeholder="Enter WB Tare Wt" >
</div>
</div>    
                                 ...
                                 <table class="table table-hover m-b-0" id="tbl">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td><input type="text" class="form-control cwth" value="{{$gate_entry->getConsignmentDetails->getUOM->unit_entry_filed}}" placeholder="" readonly=""></td>
                                          ...
                                          <td><input type="text" name="transporter" class="form-control cwth" value="{{$gate_entry->getConsignmentDetails->transporter}}" placeholder="" readonly></td>
                                       </tr>
                                    </tbody>
