...
<div class="pcoded-inner-content">
   <div class="main-body">
   <form action="{{route('cfs.out.proceed.submit')}}" id="myform" method="post">
      @csrf
      ...
      <form>
         ...
         <div class="card">
            <div class="card-block height">
               ...
               <a  target="_blank" href="{{route('cfs.out.proceed.print',['id' => base64_encode($gate_entry->id)] )}}" class="btn btn-info waves-effect waves-light">Print</a>
