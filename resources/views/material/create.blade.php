...
<li class="breadcrumb-item"><a href="#!">Material Master Create</a></li>
</ul>
</div>
</div>
</div>
               ...
               <div class="col-sm-12">
                  <div class="card">
                     <div class="card-block">
                        <form action="{{route('material.store')}}" id="myform" method="post">
                        @csrf
                           <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Material Name</label>
                              <div class="col-sm-4">
                                 <input type="text" name="material_name" value="{{old('material_name')}}" class="form-control" placeholder="Enter Material Name">
                              </div>
                             
                              <label class="col-sm-2 col-form-label">Unit Weight</label>
                              <div class="col-sm-4">
                                 <input type="number" name="unit_weight" value="{{old('unit_weight')}}" class="form-control" placeholder="Enter Unit Weight">
                              </div>
