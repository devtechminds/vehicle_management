...
<li class="breadcrumb-item">
<a href="#!">CFS Token/Ticket Wise </a></li>
</ul>
</div>
</div>
</div>
...
<input type="text" class="form-control boxbrd hgt" name="customer" id="customer" placeholder="Token Search">
...
<div class="col-sm-1 boxspace">
<form action="{{route('token.report.download')}}" method="post">
{{ csrf_field() }}
