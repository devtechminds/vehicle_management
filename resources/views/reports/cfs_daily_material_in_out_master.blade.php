...
<li class="breadcrumb-item">
<a href="#!">CFS Daily Material In Out </a></li>
</ul>
</div>
</div>
</div>
...
<div class="col-sm-1 boxspace">
<form action="{{route('cfs.daily.material.in.out.download')}}" method="post">
{{ csrf_field() }}
...
<script type="text/javascript">
        ...
        var tbl = $('#agent_datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('cfs.daily.material.in.out.master') }}",
                    type: 'GET',
                    data: function (d) {
