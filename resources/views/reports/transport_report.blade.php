...
<option value="{{$transporters['transporter']}}">{{ ucfirst($transporters['transporter']) }}</option>
@endforeach
</select>
...
<div class="col-sm-1 boxspace">
<form action="{{route('transport.report.download')}}" method="post">
{{ csrf_field() }}
