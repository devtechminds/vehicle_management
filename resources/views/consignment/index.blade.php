...
<li class="breadcrumb-item"><a href="#!">Consignments Master</a></li>
<li class="breadcrumb-item"><a href="#!">Consignments List</a></li>
<li class="breadcrumb-item"><a href="{{route('consignments.create')}}" class="btn btn-info btn-sm waves-effect waves-light btnspace">Add Consignment</a></li>
</ul>
</div>
</div>
</div>
...
<a href="{{ route('consignments.index')}}" title="Clear filter"><i class="fa fa-filter flt"></i></a>
</div>
...
<div class="col-lg-12 boxspace">
    <button class="btn viewModal btn-info" data-title="Active Consignment" data-msg="Do you want to active all records"  data-name="" data-url="{{route('consignments.status',['status'=>'active'])}}"  data-type="active" data-id="" data-type="active" data-id="" title="Active">Active</button>
    <button class="btn viewModal btn-info" data-title="Inactive Consignment" data-msg="Do you want to inactive all records"  data-name="" data-url="{{route('consignments.status',['status'=>'inactive'])}}"  data-type="inactive" data-id="" data-type="inactive" data-id="" title="Inactive">Inactive</button>
</div>
...
<tr>
<th class="hd">Id </th>
<th class="hd">Consignment Type</th>
        ...
        $(document).ready( function () {
           var  tbl = $('#agent_datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'consignment_type', name: 'consignment_type'},
