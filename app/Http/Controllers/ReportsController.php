...
class ReportsController extends Controller
{
        ...
        if($request->ajax()){
            ...
            if($request->report_type=='in'){
                ...
                return datatables()->of($gate_entry_data_list)
                    ...
                    return view('reports.cfs_daily_material_in_out_master')->with('commodity',$commodity);
                }
    }
        ...
        if($request->ajax()){
            ...
            if($request->report_type=='in'){
                ...
                return datatables()->of($gate_entry_data_list)
                    ...
                    return view('reports.customer_report')->with('commodity',$commodity)->with('customers',$customers);
                }
    }
    ...
    public function download(Request $request){
        ...
        return Excel::download(new ReportsExport($request->all()), 'CFS_Daily_Material_In_Out_Master.xlsx');
    ...
    public function Customerdownload(Request $request){
        ...
        return Excel::download(new CustomerExport($request->all()), 'Customer.xlsx');
