...
class DatewiseReportController extends Controller
{
            ...
            if($request->report_type=='in'){
                ...
                return datatables()->of($gate_entry_data_list)
                    ...
                    ->make(true);
                     ...
                     return view('reports.datewise_report')->with('commodity',$commodity)->with('transporter',$transporter);
                }
    }
    ...
    public function download(Request $request){
        ...
        return Excel::download(new DatewiseReportExport($request->all()), 'DatewiseReport.xlsx');
