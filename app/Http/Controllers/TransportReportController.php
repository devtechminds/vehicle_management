...
class TransportReportController extends Controller
{
            ...
            if($request->report_type=='in'){
                ...
                return datatables()->of($gate_entry_data_list)
                    ...
                    ->make(true);
                     ...
                     return view('reports.transport_report')->with('commodity',$commodity)->with('transporter',$transporter);
                }
    }
    ...
    {
        return Excel::download(new TransportExport($request->all()), 'Transport.xlsx');
    }
}
