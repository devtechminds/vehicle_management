...
class CreateFieldSupervisorEntryOutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('field_supervisor_entry_outs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('field_supervisor_entry_outs');
    }
}
